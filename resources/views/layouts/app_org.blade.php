                ...
                <div class="navbar-header">
                    ...
                    @if (!Auth::guest())
                        <ul class="nav navbar-nav " style="margin-top:6px;" >
                            <li class="btn-info" style="border-radius:5px;margin-left:5px" ><a  style="color:white" href="{{ route('genera_ordenes.index') }}"><i class="fa fa-list text-success"></i> Generar Órdenes</a></li>
                            <li class="btn-info" style="border-radius:5px;margin-left:5px" ><a  style="color:white" href="{{ route('genera_ordenes.upload') }}"><i class="fa fa-upload text-primary"></i> Subir Archivo</a></li>
                            <li class="btn-info" style="border-radius:5px;margin-left:5px" ><a  style="color:white" href="{{ route('genera_ordenes.report') }}"><i class="fa fa-file-pdf-o text-danger"></i> Reporte</a></li>
                        </ul>
                    @endif
                    ...
                    <ul class="nav navbar-nav navbar-right p-3">
                        ...
                        <li class="dropdown mt-4">
                                ...
                                <ul class="dropdown-menu" style="border-radius:5px;" role="menu">
                                    <li>
                                        <a  ><i class="fa fa-key"></i> Cambiar Clave</a>
                                    </li>
